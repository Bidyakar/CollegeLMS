...
$books_by_semester = [];
for ($i = 1; $i <= 8; $i++) {
    $stmt = $pdo->prepare("SELECT * FROM books WHERE course = 'BIM' AND semester = ? ORDER BY title");
    $stmt->execute([$i]);
...
<head>
    ...
    <title>BIM - Library Management System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1>📚 BIM Library Management</h1>
            <p style="font-size: 1.1em;">Bachelor of Information Management - 8 Semester Course</p>
            <div class="user-info">
