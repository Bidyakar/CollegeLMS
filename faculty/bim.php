...
$faculty_name = "BIM";
$faculty_full = "Bachelor of Information Management";
...
<body class="bg-gray-50">
    ...
    <section class="bg-slate-900 text-white py-24 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
            <h1 class="text-5xl lg:text-7xl font-black mb-6 tracking-tighter"><?php echo $faculty_name; ?> Curriculum</h1>
            ...
            <div class="mt-10 flex flex-wrap justify-center gap-4">
                ...
                <span class="bg-white/10 backdrop-blur-md px-6 py-2 rounded-full text-xs font-black uppercase tracking-widest border border-white/10">Subject Resources</span>
            </div>
        </div>
    </section>
                ...
                <div id="content-<?php echo $i; ?>" class="sem-content <?php echo $i!=1 ? 'hidden' : ''; ?> space-y-10 animate-fade-in">
                    ...
                    <div class="bg-red-600 rounded-[2.5rem] p-10 text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl shadow-red-200">
                        <div class="text-center md:text-left">
                            ...
                            <p class="text-red-100 text-sm font-bold opacity-80">All TU textbooks for Semester <?php echo $i; ?> are available in the KCMIT physical library.</p>
                        </div>
