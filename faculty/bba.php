...
$faculty_name = "BBA";
$faculty_full = "Bachelor of Business Administration";
...
<body class="bg-gray-50">
    ...
    <section class="bg-slate-900 text-white py-24 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
            <h1 class="text-5xl lg:text-7xl font-black mb-6 tracking-tighter uppercase"><?php echo $faculty_name; ?> ACADEMY</h1>
            ...
            <div class="mt-10 flex flex-wrap justify-center gap-4">
                ...
                <span class="bg-white/10 backdrop-blur-md px-6 py-2 rounded-full text-xs font-black uppercase tracking-widest border border-white/10">Management Focus</span>
    ...
    <div class="max-w-7xl mx-auto px-6 py-20">
        <div class="grid lg:grid-cols-4 gap-12">
            ...
            <div class="lg:col-span-1 space-y-2 sticky top-24 h-fit">
                <p class="text-[10px] font-black uppercase text-gray-400 tracking-[0.3em] mb-4 ml-2">Academic Roadmap</p>
                <?php for($i=1; $i<=8; $i++): ?>
                ...
                <div id="content-<?php echo $i; ?>" class="sem-content <?php echo $i!=1 ? 'hidden' : ''; ?> space-y-10 animate-fade-in">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <?php if(empty($resources_by_sem[$i])): ?>
                                <div class="col-span-2 py-20 text-center border-2 border-dashed border-gray-100 rounded-3xl">
                                    ...
                                    <p class="text-gray-400 font-bold italic">Resources for this semester are being updated by the BBA faculty.</p>
                                </div>
                            <?php else: ?>
                                ...
                                <div class="bg-slate-50 p-6 rounded-3xl border border-slate-100 hover:border-red-200 transition-all group">
                                    ...
                                    <p class="text-xs text-gray-500 leading-relaxed mb-6 italic"><?php echo $res['description'] ?: 'Official syllabus and resource material provided by KCMIT Business Faculty.'; ?></p>
                    ...
                    <div class="bg-red-600 rounded-[2.5rem] p-10 text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl shadow-red-200">
                        <div class="text-center md:text-left">
                            <h3 class="text-2xl font-black mb-2 uppercase tracking-tighter">Academic Inquiry?</h3>
                            <p class="text-red-100 text-sm font-bold opacity-80">All TU textbooks for BBA Semester <?php echo $i; ?> are available in the KCMIT physical library.</p>
                        </div>
